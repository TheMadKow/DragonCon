    ...
    public class ConventionBuilderTests
    {
        ...
        public void ConventionBuilder_NewConventionManipulateTickets_Success()
        {
            var builder = new ConventionBuilder(GetGateway())
                ...
                .Tickets.AddLimitedTicket(LimitedToRole.GameMaster, "GameMaster", new LocalDate(2018, 7, 7), new LocalDate(2018, 7, 8))
                .Tickets.AddLimitedTicket(LimitedToRole.Volunteer, "Volunteer", new LocalDate(2018, 7, 7), new LocalDate(2018, 7, 8))
